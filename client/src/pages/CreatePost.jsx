  ...
  return (
    <section className='max-w-7xl mx-auto'>
      ...
      <form className='mt-16 max-w-3xl ' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
          ...
          h-64 flex justify-center items-center'>
            ...
            {generatingImg && (
              ...
              justify-center items-center bg-[rgba(0,0,0,0.50]
              rounded-lg'>
                <Loader/>
              </div>
            )}
        ...
        <div className='mt-10'>
          <p className='mt-2 text-[#666e75] textt-[14px]'>Once you have created the image you want, you can share it with others in the community</p>
          <button
          type='submit'
